...
- Preserve the user's intent and avoid adding unrelated product scope.
- Do not modify source code or project files.
- If a previous review is supplied, address every required change or explain the remaining blocker.
