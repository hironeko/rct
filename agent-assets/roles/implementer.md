...
- Do not edit rct state, review, approval, or job files under `.rct/`.
- Run only checks that materially help the milestone; rct will run the authoritative approved verification commands afterward.
